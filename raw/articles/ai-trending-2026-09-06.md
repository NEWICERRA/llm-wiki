...
# AI Trending — 2026-09-06（原始数据）

## GitHub 今日 热门项目

- **mrliumdfkk/minis-euleros** | ⭐3
  MinisEulerOS - 华为云 EulerOS 2.0 上的 OpenMinis 1.13 分支：适用于 Android 的设备上 Linux AI 代理
  https://github.com/mrliumdfkk/minis-euleros

- **ficus233/AimSync-made-for-fps-game-sensitivity** | ⭐1
  一个用于游戏中统一灵敏度的 C++ 程序
  https://github.com/ficus233/AimSync-made-for-fps-game-sensitivity

- **Nikhil-creat/flowmind-ai** | ⭐1
  AI-powered workflow automation and document intelligence platform — RAG-based document Q&A + a visual automation builder, built with Next.js, FastAPI, Claude, and Gemini.
  https://github.com/Nikhil-creat/flowmind-ai

- **Swrang120/Smart-Commerce-AI** | ⭐1
  
  https://github.com/Swrang120/Smart-Commerce-AI

- **aaryanch1/CineMatch.AI** | ⭐1
  CineMatch AI is a transparent, content-based movie recommendation system that blends weighted preference matching with TF-IDF cosine similarity to rank titles by genre, mood, language, rating, and year. Built with Python, Pandas, and Scikit-learn, it explains every recommendation and includes a live, interactive Streamlit dashboard.
  https://github.com/aaryanch1/CineMatch.AI

- **anliang0306/AI-Governance-Audit-Kit** | ⭐1
  AI 治理和安全审计可交付套件：12 域 310 多个清单、PBC 请求列表、管理层访谈、工作底稿、风险登记册、LLM/RAG/Agent 测试用例。符合 NIST AI RMF 2.0 / ISO-IEC 42001 / OWASP LLM Top10 2025 / ISO 27001 / China GenAI 规则。
  https://github.com/anliang0306/AI-Governance-Audit-Kit

- **Nikhil-creat/AI-NIDS-RAG-SOC-Platform** | ⭐1
  
  https://github.com/Nikhil-creat/AI-NIDS-RAG-SOC-Platform

- **KapitalV/Live-AI-uses-Token-Monitor** | ⭐1
  显示来自您的活跃 AI 编码代理 — OpenAI ChatGPT / Codex 的准确令牌使用情况
  https://github.com/KapitalV/Live-AI-uses-Token-Monitor

- **Prince767-oss/King-Tutor** | ⭐1
  King Tutor — 面向 10-12 年级的人工智能教育平台，提供人工智能辅导、测验、作业检查、硬币、订阅和多语言学习。
  https://github.com/Prince767-oss/King-Tutor

- **biignoisee/crate** | ⭐1
  接下来怎么办？由人工智能驱动的数字箱子挖掘
  https://github.com/biignoisee/crate

## GitHub 本周 热门项目

- **anthropics/commerce-agents** | ⭐2056
...
- **gozen3ji/consulting-pptx-skill** | ⭐239
...
- **guillaumemeyer/watermarks-remover** | ⭐20812
  A privacy-first app that strips AI watermarks from content you own.
  https://github.com/guillaumemeyer/watermarks-remover

- **s1dashu/ip-as-logo-skill** | ⭐4964

...
# AI Trending — 2026-09-01（原始数据）

## GitHub 今日 热门项目

- **TrooperCitadel/rss-content-curator** | ⭐19
  Automated RSS feed aggregator and AI-powered text summarization utility for content creators.
  https://github.com/TrooperCitadel/rss-content-curator

- **BoulderCzar57/ai-batch-processor** | ⭐14
  Concurrent text and image processing utility powered by multi-provider LLM API integrations and automated prompt handlers.
  https://github.com/BoulderCzar57/ai-batch-processor

- **alphaparkinc/genpark-procedural-ast-flowchart-logic-diagram-synthesizer-skill** | ⭐8
  Procedural AST flowchart & logic diagram synthesizer (AI Flowchart Generator)
  https://github.com/alphaparkinc/genpark-procedural-ast-flowchart-logic-diagram-synthesizer-skill

- **alphaparkinc/genpark-symbolic-step-by-step-mathematical-proof-solver-skill** | ⭐8
  Symbolic step-by-step mathematical proof solver & LaTeX engine (AI Math Solver)
  https://github.com/alphaparkinc/genpark-symbolic-step-by-step-mathematical-proof-solver-skill

- **WaaZH/ZhiLiu-AgentFlow** | ⭐3
  智流 MAWP 把对话、工作流、Studio 与 Agent 市场收进统一工作台——从想法到可交付成果，一条流水线走完。
  https://github.com/WaaZH/ZhiLiu-AgentFlow

- **HUVIoptimisation/huvi-skills** | ⭐2
  Public skills by HUVI Optimisation — AI agents for service businesses (construction, trades, PME).
  https://github.com/HUVIoptimisation/huvi-skills

- **Blandskron/agnara** | ⭐2
  Agnara is a Python 3.14-native capability framework for building modern services for humans, apps and AI agents. Define business capabilities once and expose them through HTTP, MCP, A2A, events and tasks. Protocol-neutral, agent-first, async, observable, secure by design, modular and built for the post-REST era. Fast by architecture, not magic.
  https://github.com/Blandskron/agnara

- **AntonBronnfjell/tooling-agent-skill-multi_repository-name-conventions** | ⭐2
  ...
  https://github.com/AntonBronnfjell/tooling-agent-skill-multi_repository-name-conventions

- **efraneo/ai-architect** | ⭐1
  
  https://github.com/efraneo/ai-architect

- **kangzeng-hub/ai-clip** | ⭐1
  AI video editing and multimodal content analysis workbench with ASR, visual analysis, timeline QA, human review, and FFmpeg rendering.
  https://github.com/kangzeng-hub/ai-clip

## GitHub 本周 热门项目

- **Nanako0129/sepia** | ⭐1253
  De-AI writing skill for any Agent Skills-compatible agent (77+ via the Skills CLI), with native plugins for Claude Code, Codex, Grok Build, and Antigravity. Narrative-architecture repair for fiction, venue-matched rules for professional prose. Based on StoryScope (arXiv:2604.03136).
  https://github.com/Nanako0129/sepia

- **cbrock84/headcount** | ⭐860
...
- **POUND0423/AI-drama-pound** | ⭐520
  
  https://github.com/POUND0423/AI-drama-pound

- **leopard627/fire-your-seo-agency** | ⭐380
...
- **CHENG-LIANG1/real-company-interview-ai-coding-projects** | ⭐289
  三个匿名化真实 AI Coding 面试项目题与一套通用解题方法
  https://github.com/CHENG-LIANG1/real-company-interview-ai-coding-projects

## GitHub 本月 热门项目

- **guillaumemeyer/watermarks-remover** | ⭐19702
  A privacy-first app that strips AI watermarks from content you own.
  https://github.com/guillaumemeyer/watermarks-remover

- **s1dashu/ip-as-logo-skill** | ⭐4677
...
- **KKKKhazix/human-writing** | ⭐3338
  让 AI 写的中文读起来像一个具体的人在说话。通用创作与改稿 Skill，开箱即用。
  https://github.com/KKKKhazix/human-writing

- **omdsh-dev/DSH-better-sidebar** | ⭐3187

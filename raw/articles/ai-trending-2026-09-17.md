...
- **mhsefidgar/VoyageAgent** | ⭐2
  An AI-driven travel planning agent that automatically creates personalized trip itineraries, manages travel logistics, and leverages intelligent recommendations to streamline seamless voyage planning.
  https://github.com/mhsefidgar/VoyageAgent

- **JacobDaiHit/human-agent-co-math-research** | ⭐2
  一个致力于人与agent协作的人机数学科研交互平台，避免数学科研像抽卡
  https://github.com/JacobDaiHit/human-agent-co-math-research

- **yushajiang/ai-learning** | ⭐1
  AI 起点：面向零基础学习者的 AI 编年史、大语言模型、本地部署和提示词实践
  https://github.com/yushajiang/ai-learning

- **Ritcheyy/overlook-ai** | ⭐1
  ...
  https://github.com/Ritcheyy/overlook-ai

- **eddieg73/Nuratech-ai** | ⭐1
  
  https://github.com/eddieg73/Nuratech-ai

- **savers74/ai-test** | ⭐1
  
  https://github.com/savers74/ai-test

- **wolowizardnft2022/sentinel-ai** | ⭐1
  AI-powered offensive security & recon platform for bug bounty hunters. Local Ollama triage, intercepting proxy, nuclei/subfinder pipeline. Authorized targets only.
  https://github.com/wolowizardnft2022/sentinel-ai

- **beatra-ai/beatra-ai** | ⭐1
  Beatra AI profile — generate images, video, music, and speech from your agent
  https://github.com/beatra-ai/beatra-ai

- **25A31A4217/smart-agriculture-ai** | ⭐1
  smart agriculture ai
  https://github.com/25A31A4217/smart-agriculture-ai

## GitHub 本周 热门项目

- **ai-sucks-butt/ai-sucks-butt** | ⭐1907
  If you think AI sucks, star the repo.
  https://github.com/ai-sucks-butt/ai-sucks-butt

- **kruzovic7/ai-data-extractor** | ⭐827
...
- **rizqinrr/viserys-agent** | ⭐660
  
  https://github.com/rizqinrr/viserys-agent

- **youngyangyang04/llm-master** | ⭐571
...
- **groundboxerrespect/Dlls5-auto** | ⭐255
  ...
  https://github.com/groundboxerrespect/Dlls5-auto

## GitHub 本月 热门项目

- **bojieli/ai-infra-book** | ⭐3937
...
- **anthropics/commerce-agents** | ⭐2932
...
- **totec448-spec/chat-on-steroids** | ⭐2858
...
- **Player-YN/PawWork_ZhuaZhua** | ⭐2767

...
# AI Trending — 2026-08-30（原始数据）

## GitHub 今日 热门项目

- **alphaparkinc/genpark-multimodal-meeting-audio-agenda-task-extractor-skill** | ⭐8
  Multimodal meeting audio scribe & agenda task extractor (Granola AI style)
  https://github.com/alphaparkinc/genpark-multimodal-meeting-audio-agenda-task-extractor-skill

- **alphaparkinc/genpark-prompt-guided-video-color-grading-lut-engine-skill** | ⭐8
  Prompt-guided video color grading & 3D LUT matrix generator (Colorlab.ai style)
  https://github.com/alphaparkinc/genpark-prompt-guided-video-color-grading-lut-engine-skill

- **alphaparkinc/genpark-kubernetes-gitops-manifest-drift-reconciliation-skill** | ⭐8
  Kubernetes GitOps manifest drift reconciliation & security scanner (GitLab Agent style)
  https://github.com/alphaparkinc/genpark-kubernetes-gitops-manifest-drift-reconciliation-skill

- **alphaparkinc/genpark-parametric-camera-orbit-cinematic-video-director-skill** | ⭐8
  Parametric camera orbit cinematic video director & physics agent (Runway Gen-3 style)
  https://github.com/alphaparkinc/genpark-parametric-camera-orbit-cinematic-video-director-skill

- **z7j5r9hz2j-ui/Aisecret** | ⭐1
  AI Agent for my daily routine.
  https://github.com/z7j5r9hz2j-ui/Aisecret

- **pravingaonkar1969-cloud/ai-project** | ⭐1
  AI project
  https://github.com/pravingaonkar1969-cloud/ai-project

- **wwknow/aivf-ccs** | ⭐1
  Verifiable runtime evidence and fail-closed enforcement for AI agent tool execution.
  https://github.com/wwknow/aivf-ccs

- **vo54ftydas/ftmbAIOEJL** | ⭐1
  2022收计算机毕设一套定稿(论文+程序源代码+数据库+说明)ssm346宠物综合服务平台的设计与实现+vue.zip
  https://github.com/vo54ftydas/ftmbAIOEJL

- **M-LaScala/Portifolio-Pixel-Ai** | ⭐1
  
  https://github.com/M-LaScala/Portifolio-Pixel-Ai

- **LeRam1s/ai-coding-assistant** | ⭐1
  VSCode 内嵌 AI 对话扩展，支持任意 OpenAI 兼容大模型，无遥测、可自定义
  https://github.com/LeRam1s/ai-coding-assistant

## GitHub 本周 热门项目

- **amosblomqvist/learn** | ⭐782
  My AI learning system.
  https://github.com/amosblomqvist/learn

- **Nanako0129/sepia** | ⭐681
...
- **guillaumemeyer/watermarks-remover** | ⭐19266
  A privacy-first app that strips AI watermarks from content you own.
  https://github.com/guillaumemeyer/watermarks-remover

- **s1dashu/ip-as-logo-skill** | ⭐4557

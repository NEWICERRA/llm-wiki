...
# AI Trending — 2026-09-18（原始数据）

## GitHub 今日 热门项目

- **Ajiumeng123/dragon-work** | ⭐2
  本地 AI 工作台：对话、Skill、MCP 与项目管理，内嵌 Spring Boot 内核，数据留在本机。
  https://github.com/Ajiumeng123/dragon-work

- **MinEagle/AgentMonitor** | ⭐2
  macOS 菜单栏常驻的 AI 编码工具监控面板 · 同时盯着 Qoder / ZCode / WorkBuddy 的速度、token、缓存命中与花费。原生 Swift，只读本机数据，不联网。
  https://github.com/MinEagle/AgentMonitor

- **durgaprasadmalluri1910-collab/taskflow-ai** | ⭐1
  TaskFlow AI personal admin website
  https://github.com/durgaprasadmalluri1910-collab/taskflow-ai

- **yahyasanusiy07-cpu/Sakhfambahh-AI** | ⭐1
  An English teacher App
  https://github.com/yahyasanusiy07-cpu/Sakhfambahh-AI

- **JochenZhou/ha-aircloud** | ⭐1
  Unofficial Home Assistant integration for OpenLuat AirCloud / 合宙 IoT GPS trackers (pet & asset trackers)
  https://github.com/JochenZhou/ha-aircloud

- **rafaelalsilveira/rafaelalsilveira** | ⭐1
  AI Automation, n8n, AI Agents, and practical workflow projects.
  https://github.com/rafaelalsilveira/rafaelalsilveira

- **wnersdevv/ai-bot** | ⭐1
  TR'nin En Gelişmiş Çoklu Aİ Discord Bot Altyapisi
...
- **SHAD0WSLA3YR/Vidscribe-AI** | ⭐1
  VidScribe AI — turn lectures and videos into searchable transcripts, summaries, chapters, explanations, translations, and ready-to-use notes.
...
- **youngyangyang04/llm-master** | ⭐691
...
- **jarrodwatts/jev-trader** | ⭐546
  One AI trade decision every Monad block. Jev on Kuru MON-USDC.
  https://github.com/jarrodwatts/jev-trader

- **korcarc/text-humanizer** | ⭐412
...
- **anthropics/commerce-agents** | ⭐2957

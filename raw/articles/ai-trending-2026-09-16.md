...
- **2439810550/AgentTSC** | ⭐2
  
  https://github.com/2439810550/AgentTSC

- **kadidalax/komari-classic** | ⭐2
  komari-classic：FIX komari-1.2.5-fix2，komari-web-1.2.5-fix2，komari-agent-1.2.60
  https://github.com/kadidalax/komari-classic

- **pushonboardpublish/bharat-ai2** | ⭐1
  
  https://github.com/pushonboardpublish/bharat-ai2

- **pushonboardpublish/Aibharat** | ⭐1
  bharat ai auto
  https://github.com/pushonboardpublish/Aibharat

- **kamounael817-code/AIBusiness** | ⭐1
  Plateforme de vente de produits et services IA avec système de paiement Stripe & PayPal
  https://github.com/kamounael817-code/AIBusiness

- **1010n111/e-aio** | ⭐1
  企业级一体化管理系统（e-aio）：全开源、自托管、Spring Modulith 模块化单体。通用能力大一统（OA/CRM/库存/财务/工作流/审批/权限/审计/AI 等 22 模块），业务逻辑按企业定制，支持母子公司多级组织权限与双审计体系。
  https://github.com/1010n111/e-aio

- **tkarcheski/ai-pilled** | ⭐1
  Full-stack automation: intelligent agents for security audits, code reviews, git validation, and lazy engineering. Works with Claude Code, OpenAI, Anthropic, OpenCode, or any LLM.
  https://github.com/tkarcheski/ai-pilled

- **tterrag5/TGMusicAI** | ⭐1
  
  https://github.com/tterrag5/TGMusicAI

- **EvanZheng11/ai-cmd-proxy** | ⭐1
  commandcode go plan 代理器
  https://github.com/EvanZheng11/ai-cmd-proxy

## GitHub 本周 热门项目

- **ai-sucks-butt/ai-sucks-butt** | ⭐863
  If you think AI sucks, star the repo.
  https://github.com/ai-sucks-butt/ai-sucks-butt

- **kruzovic7/ai-data-extractor** | ⭐823
...
- **anthropics/commerce-agents** | ⭐2894
...
- **totec448-spec/chat-on-steroids** | ⭐2759

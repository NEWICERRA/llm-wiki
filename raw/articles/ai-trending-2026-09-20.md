...
# AI Trending — 2026-09-20（原始数据）

## GitHub 今日 热门项目

- **Astro-Han/jev-harness** | ⭐3
...
- **vyshnaviburri241-bot/Factory-Lens-AI** | ⭐1
  PROTOTYPE
  https://github.com/vyshnaviburri241-bot/Factory-Lens-AI

- **akitaonrails/ai-memory-web** | ⭐1
  Website for the ai-memory project
  https://github.com/akitaonrails/ai-memory-web

- **CALISKAN-EMRE/APS-Chess-AI** | ⭐1
  APS Machine Learning Team chess engine — neural value network, alpha-beta search, PVS, transposition tables, and exhibition-ready Human vs AI interface.
...
- **Cookieie2004/cookie-ai-competitor-agent** | ⭐1
  Cookie Cookie AI 竞品分析 Agent 协作系统
...
- **couchassociates/deck-kit** | ⭐1
  use AI, make great visuals
  https://github.com/couchassociates/deck-kit

- **Mistertelecom/NEXUS-AI-Gateway-with-JEV** | ⭐1
...
- **MiKaMoRe/relay** | ⭐1
  local ollama based AI-assistent
  https://github.com/MiKaMoRe/relay

## GitHub 本周 热门项目

- **mcncarl/jianying-headless** | ⭐1600
...
- **jarrodwatts/jev-trader** | ⭐1315
  One AI trade decision every Monad block. Jev on Kuru MON-USDC.
  https://github.com/jarrodwatts/jev-trader

- **korcarc/text-humanizer** | ⭐729
...
- **anthropics/commerce-agents** | ⭐2976
...
- **Player-YN/PawWork_ZhuaZhua** | ⭐2844
